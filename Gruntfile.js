...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          'dist/epi-tinymce-ai-plugin/plugin.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ],
          'dist/epi-tinymce-ai-plugin/plugin.min.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ]
        }
        ...
        files: [
          {
            cwd: 'src/text',
            src: ['license.txt'],
            dest: 'dist/epi-tinymce-ai-plugin',
            expand: true
          },
          { src: ['changelog.txt'], dest: 'dist/epi-tinymce-ai-plugin', expand: true }
        ]
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', function () {
    grunt.file.write('dist/epi-tinymce-ai-plugin/version.txt', BUILD_VERSION);
  });
